"""
Django settings for asdf_46171 project.
...
WSGI_APPLICATION = 'asdf_46171.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "asdf_46171 API",
    "DESCRIPTION": "API documentation for asdf_46171 App",
    "VERSION": "v1",
}
